      ...
      <div style={{ width: '100%', maxWidth: '400px' }}>
        ...
        <div className="auth-card animate-slidein">
          <div className="auth-logo">
            ...
            <h1>InstaClone</h1>
            <p style={{ color: 'var(--color-text-secondary)', fontSize: '14px', marginTop: '4px' }}>Sign in to see photos from friends</p>
          </div>
          ...
          <form className="auth-form" onSubmit={handleLogin}>
            ...
            {error && (
              <div style={{ color: 'var(--color-accent-primary)', fontSize: '13px', textAlign: 'center' }}>
                {error}
              </div>
            )}
            ...
            <div style={{ textAlign: 'center' }}>
              <a href="#" style={{ color: '#0095f6', fontSize: '13px' }}>Forgot password?</a>
            </div>
          </form>
        </div>
        ...
        <div style={{ textAlign: 'center', marginTop: '20px' }}>
          <p style={{ color: 'var(--color-text-secondary)', fontSize: '13px' }}>Get the app.</p>
        </div>
      </div>
    </div>
  )
